...
func create_move_command(board_position:  Vector2, next_board_position: Vector2, piece: Piece) -> MoveCommand:
...
func create_merge_command(board_position: Vector2, next_board_position: Vector2, piece: Piece, turnCommand: TurnCommand) -> MergeCommand:
